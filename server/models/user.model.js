...
//zod schema, zod is basically a tool that helps to validate and parse data in a very clear and easy-to-use way.
...
const validateField = (field, value) => {
  const result = userZodSchema.shape[field].safeParse(value); // to parse and validate a particular field of a user object
